...
namespace Tests.LibraryApp.Integration
{
    public abstract class TestWithDb<T> : IDisposable where T : DbContext
    {
        private const string ConnectionString = "server=localhost;database=libraryAPI;trusted_connection=true;Encrypt=false";
